...
export interface Stage { id: string; name: string; description: string; dueDate: string; documents: string; submissionMethod: string; evidence: string; notes: string; contact: string; review?: boolean; }
...
export interface Submission { studentId: string; departmentId: string; stageId: string; at: string; }
export interface ContactRecord { studentId: string; departmentId: string; professorId: string; at: string; }
export interface BoardState { students: Student[]; professors: Professor[]; applications: Application[]; histories: History[]; submissions: Submission[]; contacts: ContactRecord[]; }
