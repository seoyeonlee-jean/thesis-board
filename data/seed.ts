...
export const seedStudents: Student[] = [
  ...
  {id:'student-2', name:'박도윤', studentNo:'2023-10002', graduationSemester:'2027년 2월', registeredSemesters:8, majors:[{departmentId:'mechanical',role:'primary'}], enrollmentIds:['section-mech-1']},
...
export const createSeed = (): BoardState => ({
  ...
  assistants:[{id:'assistant-psych',name:'정유진 조교',departmentId:'psychology'}],
  ...
  procedureDrafts:{},procedureSavedAt:{},drafts:[],applications:[],submissions:[],meetings:[],notices:[],noticeDrafts:{},notifications:[],completions:[],
  histories:[{id:'seed',actor:'시스템',at:'2026-09-22T00:00:00Z',detail:'2차 명세 가상 시드를 준비했습니다.'}],
});
